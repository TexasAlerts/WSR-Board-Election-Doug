export const metadata = {
  ...
  description:
    "Doug Charles' vision for Prosper Town Council Place 5: A 20-year resident and former P&Z Commissioner preparing to serve with a commitment to listening, planning, and protecting.",
  openGraph: {
    title: 'My Vision - Doug Charles — Prosper Town Council, Place 5',
    description:
      "Doug Charles' vision for Prosper Town Council Place 5: A 20-year resident and former P&Z Commissioner preparing to serve with a commitment to listening, planning, and protecting.",
