              ...
              {TABS.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 md:px-5 py-2.5 rounded-lg font-semibold text-sm md:text-base transition-colors duration-200 min-h-[44px] ${
                      activeTab === tab.id
                ...
                {TABS.map((tab) => {
                  ...
                  return (
                    <button
                      key={tab.id}
                      onClick={() => handleTabChange(tab.id)}
                      className={`flex items-center gap-1.5 px-3 py-2.5 rounded-lg font-semibold text-sm whitespace-nowrap transition-colors duration-200 min-h-[44px] ${
                        activeTab === tab.id
                          ? 'bg-navy text-white shadow-md'
