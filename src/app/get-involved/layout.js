export const metadata = {
  ...
  description:
    "Get involved with Doug Charles's campaign for Prosper Town Council Place 5. Request a yard sign, volunteer, or sign up for updates.",
  openGraph: {
    title: 'Get Involved | Doug Charles for Prosper Town Council',
    description:
      "Get involved with Doug Charles's campaign for Prosper Town Council Place 5. Request a yard sign, volunteer, or sign up for updates.",
  ...
  twitter: {
    ...
    title: 'Get Involved | Doug Charles for Prosper Town Council',
    description:
      'Request a yard sign, volunteer, or sign up for updates. Join the campaign for Prosper Town Council Place 5.',
