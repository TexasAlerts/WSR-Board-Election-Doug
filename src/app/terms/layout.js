export const metadata = {
  ...
  description: 'Terms of use for the Doug Charles for Prosper Town Council Place 5 campaign website. Review the rules governing your use of dougcharles.com.',
  openGraph: {
    title: 'Terms of Use | Doug Charles for Prosper Town Council',
    description: 'Terms of use for the Doug Charles for Prosper Town Council Place 5 campaign website. Review the rules governing your use of dougcharles.com.',
