export const metadata = {
  ...
  description:
    'Support Doug Charles for Prosper Town Council Place 5. Local elections are decided by a few hundred votes. Your contribution helps reach every voter.',
  openGraph: {
    title: 'Donate | Doug Charles for Prosper Town Council',
    description:
      'Support Doug Charles for Prosper Town Council Place 5. Local elections are decided by a few hundred votes. Your contribution helps reach every voter.',
  ...
  twitter: {
    ...
    title: 'Donate | Doug Charles for Prosper Town Council',
    description:
      'Support Doug Charles for Prosper Town Council Place 5. Your contribution helps reach every voter.',
