          ...
          <div className="space-y-5 mt-10">
            <div className="card">
              <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
                <time dateTime="2019-11" className="text-sm font-bold text-navy whitespace-nowrap bg-navy/5 px-3 py-1 rounded-full self-start">Nov 2019</time>
                <div>
            ...
            <div className="card">
              <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
                <time dateTime="2020-08" className="text-sm font-bold text-navy whitespace-nowrap bg-navy/5 px-3 py-1 rounded-full self-start">Aug 2020</time>
                <div>
            ...
            <div className="card">
              <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
                <time dateTime="2020-11" className="text-sm font-bold text-navy whitespace-nowrap bg-navy/5 px-3 py-1 rounded-full self-start">Nov 2020</time>
                <div>
            ...
            <div className="card">
              <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
                <time dateTime="2021-09" className="text-sm font-bold text-navy whitespace-nowrap bg-navy/5 px-3 py-1 rounded-full self-start">Sept 2021</time>
                <div>
            ...
            <div className="card">
              <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
                <time dateTime="2021/2023" className="text-sm font-bold text-navy whitespace-nowrap bg-navy/5 px-3 py-1 rounded-full self-start">2021-2023</time>
                <div>
            ...
            <div className="card">
              <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
                <time dateTime="2023-11" className="text-sm font-bold text-navy whitespace-nowrap bg-navy/5 px-3 py-1 rounded-full self-start">Nov 2023</time>
                <div>
                  ...
                  <p className="text-gray-500 italic text-sm">"We need smart spending that maximizes benefits for our students without unnecessary burdens on our finances." — <a href="https://texasscorecard.com/local/prosper-isd-passes-3-bonds-totaling-2-7-billion-stadium-bond-fails/" target="_blank" rel="noopener noreferrer" className="text-navy hover:underline">Texas Scorecard</a></p>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
                <time dateTime="2025-04" className="text-sm font-bold text-navy whitespace-nowrap bg-navy/5 px-3 py-1 rounded-full self-start">Apr 2025</time>
                <div>
                  ...
                  <p className="text-gray-500 italic text-sm">"$115,000 just didn't randomly show up from Washington, D.C., into Prosper ISD. There's an agenda." — <a href="https://www.dallasnews.com/news/elections/2025/04/29/state-ethics-panel-to-review-allegations-of-dark-money-in-prosper-isd-trustee-race/" target="_blank" rel="noopener noreferrer" className="text-navy hover:underline">Dallas Morning News</a></p>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
                <time dateTime="2025-10" className="text-sm font-bold text-navy whitespace-nowrap bg-navy/5 px-3 py-1 rounded-full self-start">Oct 2025</time>
                <div>
            ...
            <div className="card">
              <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
                <time dateTime="2025-11" className="text-sm font-bold text-navy whitespace-nowrap bg-navy/5 px-3 py-1 rounded-full self-start">Nov 2025</time>
                <div>
                  ...
                  <p className="text-gray-500 italic text-sm">"Let's build it once, not twice—unless we're going to build it once and expand it with a thoughtful plan that's communicated." — <a href="https://communityimpact.com/dallas-fort-worth/prosper-celina/government/2025/11/21/prosper-officials-consider-next-steps-alternative-funding-after-partial-bond-failure/" target="_blank" rel="noopener noreferrer" className="text-navy hover:underline">Community Impact</a></p>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
                <time dateTime="2025-12" className="text-sm font-bold text-navy whitespace-nowrap bg-navy/5 px-3 py-1 rounded-full self-start">Dec 2025</time>
                <div>
