    ...
    <>
      ...
      <section className="py-8 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button type="button" onClick={handleEndorseClick} className="btn-primary">
            Endorse Doug
          </button>
        </div>
      </section>
            ...
            <div className="card">
              ...
              {submitMsg && submitMsg.includes('Thank you') ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    <label htmlFor="endorsement-email" className="form-label">
                      Email *
                    </label>
                    <input
                  ...
                  <fieldset className="space-y-3 pt-2">
                    ...
                    <label className="flex items-start gap-3 cursor-pointer min-h-[44px]">
                      ...
                      <span className="text-sm text-gray-600">
                        I agree to receive updates via email from dougcharles.com. You can unsubscribe at any
                        time.
                      </span>
                    </label>
                    ...
                    <label className="flex items-start gap-3 cursor-pointer min-h-[44px]">
                      ...
                      />
                      <span className="text-sm text-gray-600">
                        I agree to receive updates via text from dougcharles.com. Msg & data rates may
